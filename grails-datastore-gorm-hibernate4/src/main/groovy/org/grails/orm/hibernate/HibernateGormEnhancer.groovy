...
class HibernateGormEnhancer extends GormEnhancer {
    ...
    protected <D> GormStaticApi<D> getStaticApi(Class<D> cls, String qualifier) {
        ...
        new HibernateGormStaticApi<D>(cls, datastoreForConnection, getFinders(), Thread.currentThread().contextClassLoader, datastoreForConnection.getTransactionManager())
    }
